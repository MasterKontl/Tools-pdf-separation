...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-options { display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.5rem; font-size: 0.82rem; }
        ...
        .btn-google:hover { background: var(--bg-body); border-color: var(--text-muted); }
...
<div class="auth-container">
    <div class="logo-box">
        ...
        <p class="auth-sub">Masuk untuk mengakses kuota konversi dan dashboard Anda</p>
    </div>
    ...
    <div class="card">
        ...
        <form action="{{ route('login.attempt') }}" method="POST">
            ...
            <div class="form-options">
                ...
                <a href="{{ route('password.request') }}" class="link-text">Lupa kata sandi?</a>
            </div>
    ...
    <div class="auth-footer">
        Belum memiliki akun? <a href="{{ route('register') }}" class="link-text">Daftar sekarang</a>
    </div>
</div>
