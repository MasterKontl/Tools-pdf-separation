...
<div class="card">
    <div class="admin-filter-bar">
        <form method="GET" action="{{ route('admin.subscriptions.index') }}" class="admin-filter-form">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama atau email..." style="flex:1;min-width:180px;">
